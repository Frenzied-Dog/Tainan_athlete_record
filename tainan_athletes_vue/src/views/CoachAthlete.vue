    ...
    <div class="main-div">
      ...
      <main class="main-content">
        ...
        <ProfileCard
          ...
          :key="athlete.group"
          :profile="athlete"
          @clk="goToAthletePage(athlete.group)"
        />
      </main>
...
export default {
  ...
  methods: {
    ...
    goToAthletePage(athleteId) {
      // 使用 Vue Router 跳轉到指定的運動員頁面
      // this.$router.push({ path: `/coach-athlete/${athleteId}` });
      this.$router.push({ name: "CoachAthleteDetail", params: { id: athleteId } });
      // this.$router.push({ path: `/coach-a1/` });
    },
  },
  mounted() {
    // 組件加載完成後請求資料
