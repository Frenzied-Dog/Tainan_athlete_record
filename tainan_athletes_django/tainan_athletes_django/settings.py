"""
Django settings for tainan_athletes_django project.
...
SECRET_KEY = 'django-insecure-5f-786^t-m(@u(2ix$i(79wh5+@4@9^_gn7s0#0c=c!vc9b#j$'
...
WSGI_APPLICATION = 'tainan_athletes_django.wsgi.application'
...
CSRF_TRUSTED_ORIGINS = ['http://localhost:8080']  # We add your frontend URL here.
