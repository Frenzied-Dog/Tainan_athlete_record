    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('athlete', models.ForeignKey(help_text='運動員', on_delete=django.db.models.deletion.CASCADE, related_name='daily_train_record', to='user_data.userprofile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('athlete', models.ForeignKey(help_text='運動員', on_delete=django.db.models.deletion.CASCADE, related_name='hurt_records', to='user_data.userprofile')),
            ],
            options={
                'ordering': ['-athlete', 'date'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('athlete', models.ForeignKey(help_text='運動員', on_delete=django.db.models.deletion.CASCADE, related_name='race_record', to='user_data.userprofile')),
            ],
            options={
                'ordering': ['-athlete', '-date'],
            },
